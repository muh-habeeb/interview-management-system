...
function InterviewScheduleUI() {
  ...
  //find who are the interviewers and candidates
  ...
  //validation function for the interview creation
  function validateForm(formData: { //types
    title: string;
    description: string;
    date: Date;
    time: string;
...
//empty check
    const rules = [
      ...
      { valid: candidateId.trim() !== "", message: "Candidate is required" },
      {
  ...
  const scheduleMeeting = async () => {
    ...
    //check if candidate and interviewer are selected
